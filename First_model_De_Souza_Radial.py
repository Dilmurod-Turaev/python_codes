...
k = 1e-12; kap = 0.1*3600; Q0 = 100 / 24; p0 = 25.0; Myu = 25e-9/3600
lam_p = 1000 / 3600
R = 200
N = 401
M = 251
...
for j in range(M-1):
    ...
    for i in range(1, N-1):
        F = r[i] * p[j, i] - lam_p * kap * (r1[i] * p[j, i-1] - (r1[i] + r2[i]) * p[j, i] + r2[i] * p[j, i+1])
...
for j in range(M-1):
    ...
    for i in range(d+1, N-1):
        F2 = r[i] * p2[j, i] - lam_p * kap * (r1[i] * p2[j, i-1] - (r1[i] + r2[i]) * p2[j, i] + r2[i] * p2[j, i+1])
